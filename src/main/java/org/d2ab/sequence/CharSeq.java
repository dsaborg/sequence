...
public interface CharSeq extends CharCollection {
	...
	/**
	 * @return a {@code CharSeq} where each {@link #iterator()} is generated by polling for a supplier and then
	 * using it to generate the sequence of characters. The sequence never terminates.
	 *
	 * @see #recurse(char, CharUnaryOperator)
	 * @see #endingAt(char)
	 * @see #until(char)
	...
	/**
	 * @return a {@code CharSeq} of random characters between the lower and upper bounds, inclusive, that never
	 * terminates. The given supplier is used to produce the instance of {@link Random} that is used, one for each new
	 * {@link #iterator()}.
	 *
	...
	/**
	 * @return the {@code char} at the given index, or an empty {@link OptionalChar} if the {@code CharSeq} is smaller
	 * than the index.
	 *
	 * @since 1.2
	 */
	...
	/**
	 * @return the first char of those in this {@code CharSeq} matching the given predicate, or an empty {@link
	 * OptionalChar} if there are no matching chars in the {@code CharSeq}.
	 *
	...
	/**
	 * @return the last char of those in this {@code CharSeq} matching the given predicate, or an empty {@link
	 * OptionalChar} if there are no matching chars in the {@code CharSeq}.
	 *
	 * @see #filter(CharPredicate)
	 * @see #at(int, CharPredicate)
	...
	/**
	 * @return the {@code char} at the given index out of chars matching the given predicate, or an empty {@link
	 * OptionalChar} if the matching {@code CharSeq} is smaller than the index.
	 *
	 * @see #filter(CharPredicate)
	 * @since 1.2
	 */
