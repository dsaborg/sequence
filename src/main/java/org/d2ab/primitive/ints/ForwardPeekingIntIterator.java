 ...
 */
public class ForwardPeekingIntIterator extends BaseIntIterator<Integer, IntIterator> {
	...
	public ForwardPeekingIntIterator(IntIterator iterator, ForwardPeekingIntFunction mapper) {
		super(iterator);
		this.mapper = mapper;
	}
