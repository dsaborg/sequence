...
public class ChainedListSequenceTest {
	...
	public void entrySequence() {
		...
		EntrySequence<Integer, String> oneEntrySequence = ChainedListSequence.of(Maps.entry(1, "1")).toEntrySequence();
		twice(() -> assertThat(oneEntrySequence, contains(Maps.entry(1, "1"))));

		EntrySequence<Integer, String> twoEntrySequence =
				ChainedListSequence.of(Maps.entry(1, "1"), Maps.entry(2, "2")).toEntrySequence();
		twice(() -> assertThat(twoEntrySequence, contains(Maps.entry(1, "1"), Maps.entry(2, "2"))));

		EntrySequence<Integer, String> threeEntrySequence =
				ChainedListSequence.of(Maps.entry(1, "1"), Maps.entry(2, "2"), Maps.entry(3, "3")).toEntrySequence();
