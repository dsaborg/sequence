...
public class DoubleSequenceTest {
	...
	public void doubleStream() {
		twice(() -> assertThat(
				empty.doubleStream().collect(ArrayDoubleList::new, DoubleList::addDouble, DoubleList::addAllDoubles),
				is(emptyIterable())));

		twice(() -> assertThat(
				_12345.doubleStream().collect(ArrayDoubleList::new, DoubleList::addDouble, DoubleList::addAllDoubles),
	...
	public void doubleStreamFromOnce() {
		DoubleSequence empty = DoubleSequence.once(DoubleIterator.of());
		assertThat(empty.doubleStream().collect(ArrayDoubleList::new, DoubleList::addDouble,
		...
		DoubleSequence sequence = DoubleSequence.once(DoubleIterator.of(1, 2, 3, 4, 5));
		assertThat(
				sequence.doubleStream().collect(ArrayDoubleList::new, DoubleList::addDouble,
				                                DoubleList::addAllDoubles),
				containsDoubles(1, 2, 3, 4, 5));
		assertThat(
				sequence.doubleStream().collect(ArrayDoubleList::new, DoubleList::addDouble,
