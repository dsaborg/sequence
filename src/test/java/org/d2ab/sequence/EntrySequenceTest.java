...
public class EntrySequenceTest {
	...
	private final EntrySequence<String, Integer> _1 = EntrySequence.of(Entries.one("1", 1));
	private final EntrySequence<String, Integer> _12 = EntrySequence.of(Entries.one("1", 1), Entries.one("2", 2));
	private final EntrySequence<String, Integer> _123 = EntrySequence.of(Entries.one("1", 1), Entries.one("2", 2),
	                                                                     Entries.one("3", 3));
	private final EntrySequence<String, Integer> _1234 = EntrySequence.of(Entries.one("1", 1), Entries.one("2", 2),
	                                                                      Entries.one("3", 3), Entries.one("4", 4));
	private final EntrySequence<String, Integer> _12345 = EntrySequence.of(Entries.one("1", 1), Entries.one("2", 2),
	                                                                       Entries.one("3", 3), Entries.one("4", 4),
	                                                                       Entries.one("5", 5));
	private final EntrySequence<String, Integer> _123456789 = EntrySequence.of(Entries.one("1", 1), Entries.one("2", 2),
	                                                                           Entries.one("3", 3), Entries.one("4", 4),
	                                                                           Entries.one("5", 5), Entries.one("6", 6),
	                                                                           Entries.one("7", 7), Entries.one("8", 8),
	                                                                           Entries.one("9", 9));
	private final EntrySequence<String, Integer> random1 = EntrySequence.of(Entries.one("17", 17));
	private final EntrySequence<String, Integer> random2 = EntrySequence.of(Entries.one("17", 17), Entries.one("32",
	                                                                                                           32));
	private final EntrySequence<String, Integer> random3 = EntrySequence.of(Entries.one("4", 4), Entries.one("2", 2),
	                                                                        Entries.one("3", 3));
	private final EntrySequence<String, Integer> random9 = EntrySequence.of(Entries.one("67", 67), Entries.one("5", 5),
	                                                                        Entries.one("43", 43), Entries.one("3", 3),
	                                                                        Entries.one("5", 5), Entries.one("7", 7),
	                                                                        Entries.one("24", 24), Entries.one("5", 5),
	                                                                        Entries.one("67", 67));
	private final Entry<String, Integer>[] entries123 = new Entry[]{Entries.one("1", 1), Entries.one("2", 2),
	                                                                Entries.one("3", 3)};
	private final Entry<String, Integer>[] entries12345 = new Entry[]{Entries.one("1", 1), Entries.one("2", 2),
	                                                                  Entries.one("3", 3), Entries.one("4", 4),
	                                                                  Entries.one("5", 5)};
	private final Entry<String, Integer>[] entries456 = new Entry[]{Entries.one("4", 4), Entries.one("5", 5),
	                                                                Entries.one("6", 6)};
	private final Entry<String, Integer>[] entries789 = new Entry[]{Entries.one("7", 7), Entries.one("8", 8),
	                                                                Entries.one("9", 9)};

	@Test
	public void ofOne() {
		twice(() -> assertThat(_1, contains(Entries.one("1", 1))));
	}
	...
	@Test
	public void ofPair() {
		assertThat(EntrySequence.ofEntry("1", 1), contains(Entries.one("1", 1)));
	}
	...
	public void forLoop() {
		...
		twice(() -> {
			...
			for (Entry<String, Integer> i : _123)
				assertThat(i, is(Entries.one(String.valueOf(expected), expected++)));
		});
	}
	...
	public void iterator() {
		twice(() -> {
			...
			assertThat(iterator.next(), is(Entries.one("1", 1)));

			assertThat(iterator.hasNext(), is(true));
			assertThat(iterator.next(), is(Entries.one("2", 2)));

			assertThat(iterator.hasNext(), is(true));
			assertThat(iterator.next(), is(Entries.one("3", 3)));
	...
	public void ofWithNulls() {
		EntrySequence<String, Integer> sequence = EntrySequence.of(Entries.one("1", 1), Entries.one(null, 2),
		                                                           Entries.one("3", 3), Entries.one("4", null),
		                                                           Entries.one(null, null));

		twice(() -> assertThat(sequence, contains(Entries.one("1", 1), Entries.one(null, 2), Entries.one("3", 3),
		                                          Entries.one("4", null), Entries.one(null, null))));
	}
	...
	public void fromIterables() {
		...
		twice(() -> assertThat(sequenceFromIterables,
		                       contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3), Entries.one("4", 4),
		                                Entries.one("5", 5), Entries.one("6", 6), Entries.one("7", 7), Entries.one("8", 8),
		                                Entries.one("9", 9))));
	}
	...
	public void skip() {
		...
		twice(() -> assertThat(skipOne, contains(Entries.one("2", 2), Entries.one("3", 3))));

		EntrySequence<String, Integer> skipTwo = _123.skip(2);
		twice(() -> assertThat(skipTwo, contains(Entries.one("3", 3))));
	...
	public void limit() {
		...
		twice(() -> assertThat(limitOne, contains(Entries.one("1", 1))));

		EntrySequence<String, Integer> limitTwo = _123.limit(2);
		twice(() -> assertThat(limitTwo, contains(Entries.one("1", 1), Entries.one("2", 2))));

		EntrySequence<String, Integer> limitThree = _123.limit(3);
		twice(() -> assertThat(limitThree, contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3))));

		EntrySequence<String, Integer> limitFour = _123.limit(4);
		twice(() -> assertThat(limitFour, contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3))));
	}
	...
	public void appendIsLazy() {
		...
		assertThat(appended, contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3), Entries.one("4", 4),
		                              Entries.one("5", 5), Entries.one("6", 6)));
	...
	public void appendIsLazyWhenSkippingHasNext() {
		Iterator<Entry<String, Integer>> first = Arrayz.iterator(Entries.one("1", 1));
		Iterator<Entry<String, Integer>> second = Arrayz.iterator(Entries.one("2", 2));
	...
	public void filter() {
		...
		twice(() -> assertThat(filtered, contains(Entries.one("2", 2), Entries.one("4", 4), Entries.one("6", 6),
		                                          Entries.one("8", 8))));
	}
	...
	public void filterAndMap() {
		...
		twice(() -> assertThat(evens, contains(Entries.one(2, "2"), Entries.one(4, "4"), Entries.one(6, "6"),
		                                       Entries.one(8, "8"))));
	}

	@Test
	public void mapBiFunction() {
		EntrySequence<Integer, String> mapped = _123.map((s, i) -> Entries.one(parseInt(s), i.toString()));
		twice(() -> assertThat(mapped, contains(Entries.one(1, "1"), Entries.one(2, "2"), Entries.one(3, "3"))));
	}
	...
	public void mapEntryFunction() {
		EntrySequence<Integer, String> mapped = _123.map(
				p -> Entries.one(parseInt(p.getKey()), p.getValue().toString()));
		twice(() -> assertThat(mapped, contains(Entries.one(1, "1"), Entries.one(2, "2"), Entries.one(3, "3"))));
	}

	@Test
	public void mapIsLazy() {
		EntrySequence<Integer, String> mapped = EntrySequence.of(Entries.one("1", 1), null) // null will be hit on map
		                                                     .map((s, i) -> Entries.one(parseInt(s), i.toString()));
	...
	public void recurse() {
		EntrySequence<String, Integer> sequence = EntrySequence.recurse("1", 1,
		                                                                (k, v) -> Entries.one(String.valueOf(v + 1),
		                                                                                     v + 1));
	...
	public void recurseTwins() {
		EntrySequence<String, Integer> sequence = EntrySequence.recurse(1, "1", (k, v) -> Entries.one(v, k),
		                                                                (k, v) -> Entries.one(v + 1,
		                                                                                      String.valueOf(v + 1)));
		twice(() -> assertThat(sequence.limit(3),
		                       contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3))));
	...
	@Test
	public void until() {
		EntrySequence<String, Integer> sequence = EntrySequence.from(_12345).until(Entries.one("4", 4));
		twice(() -> assertThat(sequence, contains(entries123)));
	}

	@Test
	public void endingAt() {
		EntrySequence<String, Integer> sequence = EntrySequence.from(_12345).endingAt(Entries.one("3", 3));
		twice(() -> assertThat(sequence, contains(entries123)));
	}

	@Test
	public void untilPredicate() {
		EntrySequence<String, Integer> sequence = EntrySequence.from(_12345).until(e -> e.equals(Entries.one("4", 4)));
		twice(() -> assertThat(sequence, contains(entries123)));
	}
	...
	public void endingAtPredicate() {
		EntrySequence<String, Integer> sequence = EntrySequence.from(_12345)
		                                                       .endingAt(e -> e.equals(Entries.one("3", 3)));
		twice(() -> assertThat(sequence, contains(entries123)));
	}
	...
	@Test
	public void reduce() {
		BinaryOperator<Entry<String, Integer>> sumEntry = (r, e) -> Entries.one(r.getKey() + e.getKey(),
		                                                                       r.getValue() + e.getValue());

		twice(() -> {
			assertThat(empty.reduce(sumEntry), is(Optional.empty()));
			assertThat(_1.reduce(sumEntry), is(Optional.of(Entries.one("1", 1))));
			assertThat(_12.reduce(sumEntry), is(Optional.of(Entries.one("12", 3))));
			assertThat(_123.reduce(sumEntry), is(Optional.of(Entries.one("123", 6))));
		});
	}
	...
	public void reduceWithIdentity() {
		BinaryOperator<Entry<String, Integer>> sumEntry = (r, e) -> Entries.one(r.getKey() + e.getKey(),
		                                                                       r.getValue() + e.getValue());
		twice(() -> {
			assertThat(empty.reduce(Entries.one("17", 17), sumEntry), is(Entries.one("17", 17)));
			assertThat(_1.reduce(Entries.one("17", 17), sumEntry), is(Entries.one("171", 18)));
			assertThat(_12.reduce(Entries.one("17", 17), sumEntry), is(Entries.one("1712", 20)));
			assertThat(_123.reduce(Entries.one("17", 17), sumEntry), is(Entries.one("17123", 23)));
		});
	}
	...
	public void reduceQuaternaryWithIdentity() {
		...
		twice(() -> {
			assertThat(empty.reduce("17", 17, sumEntry), is(Entries.one("17", 17)));
			assertThat(_1.reduce("17", 17, sumEntry), is(Entries.one("171", 18)));
			assertThat(_12.reduce("17", 17, sumEntry), is(Entries.one("1712", 20)));
			assertThat(_123.reduce("17", 17, sumEntry), is(Entries.one("17123", 23)));
		});
	}
	...
	public void first() {
		twice(() -> {
			...
			assertThat(_1.first(), is(Optional.of(Entries.one("1", 1))));
			assertThat(_12.first(), is(Optional.of(Entries.one("1", 1))));
			assertThat(_123.first(), is(Optional.of(Entries.one("1", 1))));
		});
	}
	...
	public void second() {
		twice(() -> {
			...
			assertThat(_12.second(), is(Optional.of(Entries.one("2", 2))));
			assertThat(_123.second(), is(Optional.of(Entries.one("2", 2))));
			assertThat(_1234.second(), is(Optional.of(Entries.one("2", 2))));
		});
	}
	...
	public void third() {
		twice(() -> {
			...
			assertThat(_123.third(), is(Optional.of(Entries.one("3", 3))));
			assertThat(_1234.third(), is(Optional.of(Entries.one("3", 3))));
			assertThat(_12345.third(), is(Optional.of(Entries.one("3", 3))));
		});
	}
	...
	public void last() {
		twice(() -> {
			...
			assertThat(_1.last(), is(Optional.of(Entries.one("1", 1))));
			assertThat(_12.last(), is(Optional.of(Entries.one("2", 2))));
			assertThat(_123.last(), is(Optional.of(Entries.one("3", 3))));
		});
	}
	...
	public void window() {
		twice(() -> assertThat(_12345.window(3),
		                       contains(contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3)),
		                                contains(Entries.one("2", 2), Entries.one("3", 3), Entries.one("4", 4)),
		                                contains(Entries.one("3", 3), Entries.one("4", 4), Entries.one("5", 5)))));
	}
	...
	public void batch() {
		twice(() -> assertThat(_12345.batch(3),
		                       contains(contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3)),
		                                contains(Entries.one("4", 4), Entries.one("5", 5)))));
	}
	...
	public void step() {
		twice(() -> assertThat(_123456789.step(3),
		                       contains(Entries.one("1", 1), Entries.one("4", 4), Entries.one("7", 7))));
	}
	...
	public void distinct() {
		...
		twice(() -> assertThat(oneDistinct, contains(Entries.one("17", 17))));

		EntrySequence<String, Integer> twoDuplicatesDistinct = EntrySequence.of(Entries.one("17", 17),
		                                                                        Entries.one("17", 17)).distinct();
		twice(() -> assertThat(twoDuplicatesDistinct, contains(Entries.one("17", 17))));

		EntrySequence<String, Integer> nineDistinct = random9.distinct();
		twice(() -> assertThat(nineDistinct, contains(Entries.one("67", 67), Entries.one("5", 5), Entries.one("43", 43),
		                                              Entries.one("3", 3), Entries.one("7", 7), Entries.one("24", 24))));
	}
	...
	public void sorted() {
		...
		twice(() -> assertThat(oneSorted, contains(Entries.one("17", 17))));

		EntrySequence<String, Integer> twoSorted = random2.sorted();
		twice(() -> assertThat(twoSorted, contains(Entries.one("17", 17), Entries.one("32", 32))));

		EntrySequence<String, Integer> nineSorted = random9.sorted();
		twice(() -> assertThat(nineSorted, // String sorting on first item
		                       contains(Entries.one("24", 24), Entries.one("3", 3), Entries.one("43", 43),
		                                Entries.one("5", 5), Entries.one("5", 5), Entries.one("5", 5),
		                                Entries.one("67", 67), Entries.one("67", 67), Entries.one("7", 7))));
	}
	...
	public void sortedComparator() {
		...
		twice(() -> assertThat(twoSorted, contains(Entries.one("32", 32), Entries.one("17", 17))));
		...
		twice(() -> assertThat(nineSorted, // String sorting on first item reverse
		                       contains(Entries.one("7", 7), Entries.one("67", 67), Entries.one("67", 67),
		                                Entries.one("5", 5), Entries.one("5", 5), Entries.one("5", 5),
		                                Entries.one("43", 43), Entries.one("3", 3), Entries.one("24", 24))));
	}
	...
	public void min() {
		...
		twice(() -> assertThat(oneMin, is(Optional.of(Entries.one("17", 17)))));

		Optional<Entry<String, Integer>> twoMin = random2.min((Comparator) Comparator.naturalOrder());
		twice(() -> assertThat(twoMin, is(Optional.of(Entries.one("17", 17)))));

		Optional<Entry<String, Integer>> nineMin = random9.min((Comparator) Comparator.naturalOrder());
		twice(() -> assertThat(nineMin, is(Optional.of(Entries.one("24", 24)))));
	}
	...
	public void max() {
		...
		twice(() -> assertThat(oneMax, is(Optional.of(Entries.one("17", 17)))));

		Optional<Entry<String, Integer>> twoMax = random2.max((Comparator) Comparator.naturalOrder());
		twice(() -> assertThat(twoMax, is(Optional.of(Entries.one("32", 32)))));

		Optional<Entry<String, Integer>> nineMax = random9.max((Comparator) Comparator.naturalOrder());
		twice(() -> assertThat(nineMax, is(Optional.of(Entries.one("7", 7)))));
	}
	...
	public void repeat() {
		...
		twice(() -> assertThat(repeatOne.limit(3),
		                       contains(Entries.one("1", 1), Entries.one("1", 1), Entries.one("1", 1))));

		EntrySequence<String, Integer> repeatTwo = _12.repeat();
		twice(() -> assertThat(repeatTwo.limit(5),
		                       contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("1", 1), Entries.one("2", 2),
		                                Entries.one("1", 1))));

		EntrySequence<String, Integer> repeatThree = _123.repeat();
		twice(() -> assertThat(repeatThree.limit(8),
		                       contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3), Entries.one("1", 1),
		                                Entries.one("2", 2), Entries.one("3", 3), Entries.one("1", 1),
		                                Entries.one("2", 2))));

		EntrySequence<String, Integer> repeatVarying = EntrySequence.from(new Iterable<Entry<String, Integer>>() {
			private List<Entry<String, Integer>> list = asList(Entries.one("1", 1), Entries.one("2", 2),
			                                                   Entries.one("3", 3));
			int end = list.size();
		...
		assertThat(repeatVarying,
		           contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3), Entries.one("1", 1),
		                    Entries.one("2", 2), Entries.one("1", 1)));
	}
	...
	public void repeatTwice() {
		...
		twice(() -> assertThat(repeatOne, contains(Entries.one("1", 1), Entries.one("1", 1))));

		EntrySequence<String, Integer> repeatTwo = _12.repeat(2);
		twice(() -> assertThat(repeatTwo, contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("1", 1),
		                                           Entries.one("2", 2))));

		EntrySequence<String, Integer> repeatThree = _123.repeat(2);
		twice(() -> assertThat(repeatThree,
		                       contains(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3), Entries.one("1", 1),
		                                Entries.one("2", 2), Entries.one("3", 3))));
	...
	public void reverse() {
		...
		twice(() -> assertThat(oneReversed, contains(Entries.one("1", 1))));

		EntrySequence<String, Integer> twoReversed = _12.reverse();
		twice(() -> assertThat(twoReversed, contains(Entries.one("2", 2), Entries.one("1", 1))));

		EntrySequence<String, Integer> threeReversed = _123.reverse();
		twice(() -> assertThat(threeReversed, contains(Entries.one("3", 3), Entries.one("2", 2), Entries.one("1", 1))));

		EntrySequence<String, Integer> nineReversed = _123456789.reverse();
		twice(() -> assertThat(nineReversed,
		                       contains(Entries.one("9", 9), Entries.one("8", 8), Entries.one("7", 7), Entries.one("6", 6),
		                                Entries.one("5", 5), Entries.one("4", 4), Entries.one("3", 3), Entries.one("2", 2),
		                                Entries.one("1", 1))));
	}
	...
	public void shuffle() {
		...
		assertThat(_1.shuffle(), contains(Entries.one("1", 1)));
		assertThat(_12.shuffle(), containsInAnyOrder(Entries.one("1", 1), Entries.one("2", 2)));
		assertThat(_123.shuffle(), containsInAnyOrder(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3)));
		assertThat(_123456789.shuffle(),
		           containsInAnyOrder(Entries.one("1", 1), Entries.one("2", 2), Entries.one("3", 3), Entries.one("4", 4),
		                              Entries.one("5", 5), Entries.one("6", 6), Entries.one("7", 7), Entries.one("8", 8),
		                              Entries.one("9", 9)));
	}
	...
	public void shuffleWithRandomSource() {
		...
		assertThat(_1.shuffle(seed), contains(Entries.one("1", 1)));
		assertThat(_12.shuffle(seed), contains(Entries.one("1", 1), Entries.one("2", 2)));
		assertThat(_123.shuffle(seed), contains(Entries.one("3", 3), Entries.one("2", 2), Entries.one("1", 1)));
		assertThat(_123456789.shuffle(seed),
		           contains(Entries.one("2", 2), Entries.one("9", 9), Entries.one("4", 4), Entries.one("6", 6),
		                    Entries.one("8", 8), Entries.one("7", 7), Entries.one("5", 5), Entries.one("1", 1),
		                    Entries.one("3", 3)));
	}
	...
	public void flattenKeys() {
		...
		twice(() -> assertThat(flattened,
		                       contains(Entries.one("1", 1), Entries.one("2", 1), Entries.one("3", 1), Entries.one("5", 3),
		                                Entries.one("6", 3), Entries.one("7", 3))));
	}
	...
	public void flattenValues() {
		...
		twice(() -> assertThat(flattened,
		                       contains(Entries.one("1", 1), Entries.one("1", 2), Entries.one("1", 3), Entries.one("3", 2),
		                                Entries.one("3", 3), Entries.one("3", 4))));
	}
}
