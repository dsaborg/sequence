...
public class ReverseListTest {
	...
	private final List<Integer> original = new ArrayList<>(asList(1, 2, 3, 4, 5, 6));
	...
	public void testEquals() {
		...
		assertThat(reverse.equals(asList(6, 5, 4, 3, 2, 1)), is(true));
		assertThat(reverse.equals(asList(1, 2, 3, 4, 5, 6)), is(false));
	}
