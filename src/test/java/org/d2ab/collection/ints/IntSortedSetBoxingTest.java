...
public class IntSortedSetBoxingTest {
	private final IntSet backingEmpty = new BitIntSet();
	private final SortedSet<Integer> empty = new IntSortedSet.Base() {
		@Override
	...
	private final SortedSet<Integer> set = new IntSortedSet.Base() {
		@Override
		public IntIterator iterator() {
