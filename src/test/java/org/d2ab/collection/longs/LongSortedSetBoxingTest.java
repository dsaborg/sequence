...
public class LongSortedSetBoxingTest extends BaseBoxingTest {
	...
	public void testEqualsHashCodeAgainstSet() {
		Set<Long> set2 = new HashSet<>(Lists.of(-5L, -4L, -3L, -2L, -1L, 0L, 1L, 2L, 3L, 4L, 17L));
	...
	public void containsAllCollection() {
		...
		assertThat(set.containsAll(Lists.of(1L, 2L, 3L)), is(true));
		assertThat(set.containsAll(Lists.of(1L, 2L, 3L, 17L)), is(false));
	}
