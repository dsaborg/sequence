...
public class BitLongSetBoxingTest extends BaseBoxingTest {
	private final SortedSet<Long> empty = new BitLongSet();
	private final SortedSet<Long> set = new BitLongSet(-5, -4, -3, -2, -1, 0, 1, 2, 3, 4);
	...
	public void boundaries() {
		SortedSet<Long> set = new BitLongSet();
