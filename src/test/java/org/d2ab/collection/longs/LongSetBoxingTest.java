...
public class LongSetBoxingTest {
	...
	public void addBoxed() {
		empty.add(-17L);
		empty.add(17L);
		assertThat(empty, contains(-17L, 17L));

		set.add(-17L);
		set.add(17L);
		assertThat(set, contains(-17L, -5L, -4L, -3L, -2L, -1L, 0L, 1L, 2L, 3L, 4L, 17L));
	}
	...
	public void addAllBoxed() {
		assertThat(empty.addAll(asList(-2L, -1L, 0L, 1L)), is(true));
		assertThat(empty, contains(-2L, -1L, 0L, 1L));
	...
	public void removeAllBoxed() {
		assertThat(empty.removeAll(asList(-2L, -1L, 0L, 1L)), is(false));
		assertThat(empty, is(emptyIterable()));

		assertThat(set.removeAll(asList(-2L, -1L, 0L, 1L)), is(true));
		assertThat(set, contains(-5L, -4L, -3L, 2L, 3L, 4L));
	}

	@Test
	public void retainAllBoxed() {
		assertThat(empty.retainAll(asList(-2L, -1L, 0L, 1L)), is(false));
		assertThat(empty, is(emptyIterable()));

		assertThat(set.retainAll(asList(-2L, -1L, 0L, 1L)), is(true));
		assertThat(set, contains(-2L, -1L, 0L, 1L));
	}
